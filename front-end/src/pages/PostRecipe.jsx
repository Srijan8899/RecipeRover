...
function CreatePost() {
  ...
  useEffect(() => {
    ...
    const delta1 = new Delta().insert({ list: "bullet" }); // You can use 'ordered' for numbered list or 'bullet' for bullet points
    ...
    const delta2 = new Delta().insert({ list: "bullet" });
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4 sm:flex-row justify-between">
              <textarea
                ...
                onChange={(ev) =>
                  setFormData({ ...formData, summary: ev.target.value })
                }
                //onChange={ev=>setSummary((prev)=>({...prev, summary:ev.target.value}))}
              />
            </div>
            <div className="flex md:flex-row flex-col gap-4 items-center justify-between border-gray-300 p-3">
              <FileInput
                type="file"
                accept="image/*"
                id="file-upload"
