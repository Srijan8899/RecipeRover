...
function ErrorPage() {
  return (
<div className="min-h-screen relative flex items-center justify-center overflow-hidden z-50 bg-gray-900 text-[#F8FAE5]">
    <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                <span className="my-1 text-7xl inline-block mb-10 leading-snug border-b-8 border-g4 px-4 font-bold text-g4 animate__animated animate__flash">Error 404</span>
                    <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        Page
                        <span className="my-1 inline-block px-4 font-bold">Not Found</span>
                    </h2>
                    <p className="text-base text-[#F8FAE5]">We couldn't find the page you're looking for.</p>
                    <div className="mt-10 flex flex-col items-center md:flex-row">
                        <Link to="/contact" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-blue-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            Contact Us</Link>
                        <Link to="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Go back to home page
            ...
            <div className="relative flex flex-col lg:ml-32 lg:block lg:w-1/2">
                <div className="mx-auto w-fit overflow-hidden rounded-[6rem] mt-20 rounded-br-none rounded-tl-none">
                     <img src={monkey} />
                </div>
            </div>
        </div>
