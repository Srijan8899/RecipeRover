...
import spaghettiImage from '../assets/spaghetti.jpg'; // Adjust the path based on your project structure
...
function Login() {
  ...
  return (
    <div className="w-full h-screen flex font-['Founders_Grotesk_X_Condensed'] text-[#F8FAE5]">
      <div className="relative w-1/2 hidden lg:flex flex-col">
        <img src={spaghettiImage} alt="food" className="absolute bg-cover w-full object-cover h-screen z-1 opacity-80 brightness-90" />
        <div className="flex items-center justify-center w-full h-full">
          ...
          <Link to="/signup" className="absolute flex items-center justify-center pt-24">
            <button className="border rounded-2xl bottom-60 px-14 pb-6 text-4xl pt-6 leading-[.6] bg-[#43766C] uppercase tracking-tight font-['Neue_Montreal']">Signup</button>
          </Link>
        </div>
      </div>
