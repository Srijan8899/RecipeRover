        ...
        <div className="flex w-full lg:w-1/2 justify-center items-center bg-[#5e968b] space-y-8 text-[#466e66] font-['Neue_Montreal']">
            ...
            <form onSubmit={handleSubmit} className="bg-[#F8FAE5] rounded-md shadow-4xl p-5">
              ...
              <div className="flex items-center border-2 mb-6 py-1 px-3 rounded-2xl">
                ...
                <input id="username" className="bg-[#F8FAE5] text-xl pl-2 w-full focus:ring-[#F8FAE5] border-none" type="text" name="fullName" onChange={handleChange} placeholder="Your Full Name" />
              </div>
              <div className="flex items-center border-2 mb-6 py-1 px-3 rounded-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                </svg>
                <input id="email" className="bg-[#F8FAE5] text-xl pl-2 w-full focus:ring-[#F8FAE5] border-none" type="email" name="email" onChange={handleChange}  placeholder="Email Address" />
              </div>
              <div className="flex items-center border-2 mb-6 py-1 px-3 rounded-2xl ">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <input className="pl-2 w-full focus:ring-[#F8FAE5] border-none bg-[#F8FAE5] text-xl" type="password" name="password" id="password" onChange={handleChange} placeholder="Password" />
              </div>
              <div className="flex items-center border-2 mb-6 py-1 px-3 rounded-2xl ">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <input className="pl-2 w-full focus:ring-[#F8FAE5] border-none bg-[#F8FAE5] text-xl" type="password" name="cpassword" id="cpassword" onChange={handleChange} placeholder="Confirm Password" />
              </div>
              ...
              <button type="submit" className="flex w-full bg-[#43766C] my-5 py-2 rounded-2xl hover:bg-[#39665d] hover:-translate-y-1 transition-all duration-500 text-white font-semibold text-2xl "> <FcGoogle size={30} className="mr-4"/> Signup with google </button>
            </form>
            </div>
    </div>
