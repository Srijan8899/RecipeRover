...
function Hero() {
  return (
    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg- brightness-90 bg-cover overflow-hidden" style={{ backgroundImage: `url(${menu1})` }}>
        ...
        <img src={logo} alt="logo"  className="bg-transparent object-scale-down w-52 py-3"/> </div>
        </div>
    </div> 
  )
}
